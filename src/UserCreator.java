...
public class UserCreator {
    ...
    public UserCreator() throws Exception {
        try {
            ...
            lastnames = new FileScanner("surnames.txt").getLoadedValues();
        System.out.println("\tUserCreator class: loaded " + names.size() + " names and " + lastnames.size() +
                " lastnames.");
            System.out.println("======================================================");
        } catch (Exception e) {
    ...
    public User createUser() {
        ...
        String surname = lastnames.get(getRndWithLimit(lastnames.size()));
